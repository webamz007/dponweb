                    ...
                    <div class="card-body">
                        <form action="{{ route('setting.other.update') }}" method="GET">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <div class="control-label">RazorPay Switch</div>
                                        <label class="custom-switch mt-2 pl-0">
                                            <input {{ ($setting->isRazorPay) ? 'checked' : '' }} type="checkbox" name="isRazorPay" class="custom-switch-input">
                                            <span class="custom-switch-indicator"></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <div class="control-label">Fast UPI 1 Switch</div>
                                        <label class="custom-switch mt-2 pl-0">
                                            <input {{ ($setting->isFastUPI1) ? 'checked' : '' }} type="checkbox" name="isFastUPI1" class="custom-switch-input">
                                            <span class="custom-switch-indicator"></span>
                                        </label>
                                    </div>
                                </div>
